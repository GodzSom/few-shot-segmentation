...
class CNN(torch.nn.Module):
    def __init__(self, num_class):
        ...
        self.conv4 = nn.Conv2d(64, num_class, 3, stride = 1, padding = 1)
...
class dilated_CNN_61(torch.nn.Module):
    def __init__(self, num_class):
        ...
        self.conv9 = nn.Conv2d(32, num_class, 3, stride = 1, padding = 1, dilation=1)
...
class dilated_CNN_127(torch.nn.Module):
    def __init__(self, num_class):
        super(dilated_CNN_127, self).__init__()

        self.conv1 = nn.Conv2d(in_dim, 128, 1, stride = 1, padding = 0, dilation=1)
        self.conv2 = nn.Conv2d(128, 64, 3, stride = 1, padding = 2, dilation=2)
        self.conv3 = nn.Conv2d(64, 64, 3, stride = 1, padding = 4, dilation=4)
        self.conv4 = nn.Conv2d(64, 64, 3, stride = 1, padding = 8, dilation=8)
        self.conv5 = nn.Conv2d(64, 64, 3, stride = 1, padding = 16, dilation=16)
        self.conv6 = nn.Conv2d(64, 64, 3, stride = 1, padding = 1, dilation=1)
        self.conv7 = nn.Conv2d(64, 64, 3, stride = 1, padding = 2, dilation=2)
        self.conv8 = nn.Conv2d(64, 64, 3, stride = 1, padding = 4, dilation=4)
        self.conv9 = nn.Conv2d(64, 64, 3, stride = 1, padding = 8, dilation=8)
        self.conv10 = nn.Conv2d(64, 32, 3, stride = 1, padding = 16, dilation=16)
        self.conv11 = nn.Conv2d(32, num_class, 3, stride = 1, padding = 1, dilation=1)
